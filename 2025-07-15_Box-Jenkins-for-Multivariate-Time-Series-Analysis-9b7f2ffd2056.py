...
# Plot the forecast
plt.figure(figsize=(12, 6))
plt.plot(data.index[-100:], data["INDPRO"][-100:], label="Industrial Production (Observed)", linestyle="-")
plt.plot(data.index[-100:], data["RSAFS"][-100:], label="Retail Sales (Observed)", linestyle="-")
plt.plot(forecast_actual.index, forecast_actual["INDPRO"], label="Industrial Production (Forecast)", linestyle="--")
plt.plot(forecast_actual.index, forecast_actual["RSAFS"], label="Retail Sales (Forecast)", linestyle="--")
...
ax.plot(scaled.index, scaled['INDPRO'], label='Industrial Production (scaled)', linewidth=2)
